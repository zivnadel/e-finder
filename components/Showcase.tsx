...
const Showcase: React.FC = () => {
  return (
    <div className="text-center text-white font-quicksand h-screen overflow-auto bg-gradient-to-r from-primary to-secondary flex items-center justify-center flex-col p-3 md:p-0">
